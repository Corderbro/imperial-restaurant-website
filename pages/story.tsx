...
export default function Story() {
  const events = [
    {
      day: "Monday",
      title: "Robert's Trivia Night",
      time: "8:00 PM",
      color: "text-neon-red",
      description: "Join Robert Holland for the best trivia night in Decatur!"
    },
    {
      day: "Tuesday", 
  ...
  return (
    <>
      <SEOHead 
        ...
        description="Join us for Robert Holland Trivia every Monday and Tuesday at 8pm! Learn about The Imperial's history as a converted 1920s service station in Decatur, GA."
        canonical="/story"
        pageType="about"
      />
      <Layout>
